...
router.post("/create-payment", async (req, res) => {
  // Логируем тело запроса, чтобы видеть, что приходит из фронта
  ...
  try {
    ...
    // Детализируем логи по ответу от Plisio и сообщению ошибки
...
router.post("/callback", async (req, res) => {
  // Логируем тело callback-запроса от Plisio
